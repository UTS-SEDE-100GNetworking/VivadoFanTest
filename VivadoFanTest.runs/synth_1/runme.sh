...
HD_PWD='C:/Users/dstg_hz/Documents/Projects/VivadoFanTest/VivadoFanTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBlock_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBlock_wrapper.tcl
